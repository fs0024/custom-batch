...
public class WaitingAreaTest {
    ...
    public void before() throws Exception {
        ...
        ReflectionTestUtils.setField(waitingArea,"timeout" ,100L);
        ReflectionTestUtils.setField(waitingArea,"sleepTime" ,100L);
    ...
    public void testBeforeStep() throws Exception {
        ...
        waitingArea.beforeStep(stepExecution);
    ...
    public void testAfterStep() throws Exception {
        waitingArea.afterStep(stepExecution);
...
//TODO: Test goes here...
    ...
    public void testExecute() throws Exception {
        ...
        Mockito.when(parameters.getString(Mockito.anyString())).thenReturn("Worker");
         Mockito.when(stepExecution.getJobExecution()).thenReturn(execution);
          Mockito.when(batchApiService.getPrepTask(Mockito.anyString(),Mockito.any())).thenThrow( new Exception());
           RepeatStatus status = waitingArea.execute(stepContribution,chunkContext);
    ...
    public void testExecuteException() throws Exception {
        ...
        Assertions. assertThrows(Exception.class,
                ()->{
                    waitingArea.execute(stepContribution,chunkContext);
